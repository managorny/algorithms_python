"""
Проанализировать скорость и сложность одного любого алгоритма из разработанныхв рамках домашнего задания
первых трех уроков.

4. Определить, какое число в массиве встречается чаще всего.
Дополнил: если есть числа, которые повторяются одинаково больше остальных, то определить и их.
"""
